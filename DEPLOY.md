...
The server key enables AI requests for anyone who can access the deployed app, billed to that API account. Use private app access for a private demonstration. No API key is included in this package. The input override is session-only and is never exported.
